...
BOOST_AUTO_TEST_CASE(setPosition_method)
{
	CPointShape shape(1, 4);
...
BOOST_AUTO_TEST_CASE(Area_and_Perimetr_method)
{
	CPointShape shape(1, 4);
...
BOOST_AUTO_TEST_CASE(type_method)
{
	CPointShape shape(1, 4);
...
BOOST_AUTO_TEST_CASE(Area_method)
{
	CLineSegment line(CPoint(1, 4), CPoint(2, 6));
	BOOST_CHECK_EQUAL(line.GetArea(), 0);
}

BOOST_AUTO_TEST_CASE(Perimetr_method)
{
...
BOOST_AUTO_TEST_CASE(Set_position_method)
{
	CRectangle rect(CPoint(0, 0), 4, 4);
...
BOOST_AUTO_TEST_CASE(Set_size_method)
{
	CRectangle rect(CPoint(0, 0), 4, 4);
	rect.SetSize(10, 12);
